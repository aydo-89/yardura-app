...
export default function WellnessPoopMapScreen() {
  ...
  const availabilityNotice =
    !loading && !error
      ? homeLocation && parcelAvailability === 'missing'
        ? "Poop map parcel boundaries aren’t available in your area yet. We’ll still show capture pins/heatmap when available, but we can’t outline your yard boundary."
        : !homeLocation
          ? "Add your home/service address to enable the poop map. Without a home location, we can’t anchor the map to your yard."
          : null
      : null;
    ...
    <Screen>
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <Text style={[styles.title, { color: palette.text }]}>See patterns across your yard</Text>
        ...
        {loading ? (
          ...
          <View style={styles.noticeRow}>
            <Text style={[styles.helperText, { color: palette.muted }]}>{availabilityNotice}</Text>
          </View>
        ) : null}
