...
function resolveAsset(asset: ImageAsset) {
  return {
    uri: asset.uri,
    name: asset.fileName ?? `bag-drop-${Date.now()}.jpg`,
...
export default function BagDropStepScreen() {
  ...
  const handleCapture = async () => {
    ...
    await uploadMedia(asset, { assetType: 'BAG_DROP' });
  ...
  return (
    <VisitStepShell
      title={disposalCopy.title}
      subtitle={disposalCopy.subtitle}
      stepIndex={stepIndex}
