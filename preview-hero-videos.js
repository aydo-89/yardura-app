...
const videos = [
  {
    ...
    description: 'Lifestyle style - Man and woman laughing with golden retriever in clean backyard',
    size: '5.9MB'
  },
  {
    file: 'hero-option2-family.mp4', 
    title: 'Young Family with Children & Labrador',
    description: 'Commercial style - Kids playing fetch with labrador, parents watching',
    size: '11.0MB'
  }
]
...
if (command === '1') {
  // Copy option 1
  fs.copyFileSync('./public/hero-option1-couple.mp4', './public/hero-video.mp4')
  console.log('✅ Set hero video to Option 1: Happy Couple with Golden Retriever')
  console.log('🔄 Refresh your browser to see the change!')
} else if (command === '2') {
  // Copy option 2  
  fs.copyFileSync('./public/hero-option2-family.mp4', './public/hero-video.mp4')
  console.log('✅ Set hero video to Option 2: Young Family with Children & Labrador')
  console.log('🔄 Refresh your browser to see the change!')
} else {
  showVideoOptions()
}
