...
export const frequencySchema = z.enum(['weekly', 'biweekly', 'twice-weekly', 'monthly', 'one-time'], {
  message: 'Please select a service frequency',
});

export const dogsSchema = z.number()
...
export const businessTypeSchema = z.string()
...
export const referralSourceSchema = z.string()
...
export type StepCommercialContactData = z.infer<typeof stepCommercialContactSchema>;
