...
export function generateWeekReadings(scenarioOrWeekStart: keyof typeof MOCK_SCENARIOS | Date = 'healthy', scenario?: keyof typeof MOCK_SCENARIOS): WeekRollup[] {
  // Handle both calling patterns: generateWeekReadings(scenario) or generateWeekReadings(weekStart, scenario)
  const actualScenario = typeof scenarioOrWeekStart === 'string' ? scenarioOrWeekStart : (scenario || 'healthy');
