...
const APP_URL = "insightscoop://earnings?stripe=return";
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-900 px-6 py-16 text-white">
      <div className="w-full max-w-md rounded-3xl border border-white/10 bg-slate-950/70 p-8 text-center shadow-2xl shadow-black/40">
        ...
        <h1 className="mt-4 text-2xl font-semibold text-white">Finish payout setup</h1>
        <p className="mt-3 text-sm text-slate-300">
          Return to the InsightScoop app to confirm your payout method and check
          whether Stripe Express still needs anything from you.
        </p>
        <a
          href={APP_URL}
