        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            <div className="text-center p-6 bg-white/60 backdrop-blur-sm border border-slate-200/60 rounded-3xl shadow-xl">
              <div className="text-3xl font-black text-brand-600 mb-2">
                {cities.length}+
              </div>
                ...
                <CardContent className="relative z-10">
                  <div className="space-y-4">
                    ...
                    <p className="text-sm text-slate-600 leading-relaxed">
                      Professional dog waste removal with wellness insights and
          ...
          <div className="mt-20 text-center">
            <div className="bg-white/60 backdrop-blur-sm border border-slate-200/60 rounded-3xl p-12 shadow-xl">
              ...
              <p className="text-lg text-slate-600 mb-8 max-w-2xl mx-auto">
                We're expanding across the Twin Cities metro area. Get in touch
                to see if we can serve your location.
              </p>
