...
import { AlertTriangle, Users, Shield, Database, Settings, Crown } from 'lucide-react';
...
export default function GodModePage() {
  ...
  const sendInvite = async () => {
    if (!inviteUser.email.trim() || !inviteUser.name.trim() || !inviteUser.orgId.trim()) {
          ...
          <div className="mb-6">
            ...
            {showInviteUser && (
              <Card className="p-4 bg-blue-50 border-blue-200">
                <h3 className="text-lg font-medium mb-4">Invite Business Admin</h3>
                <p className="text-sm text-blue-700 mb-4">
                  Create an admin account for a new business and send them an invitation email with setup instructions.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setInviteUser({ ...inviteUser, orgId: e.target.value })}
                      className="w-full px-3 py-2 border border-blue-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setInviteUser({ ...inviteUser, role: e.target.value as 'ADMIN' | 'CUSTOMER' })}
                      className="w-full px-3 py-2 border border-blue-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    >
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    className="bg-blue-600 hover:bg-blue-700"
                  >
                    {inviting ? 'Sending Invitation...' : 'Create Account & Send Invite'}
                  </Button>
                  <Button
              ...
              <div key={user.id} className="flex items-center justify-between p-4 border rounded-lg">
                <div className="flex-1">
                  ...
                  <div className="text-sm text-muted-foreground">
                    ...
                    <span className="ml-4">Leads: {user._count.assignedLeads}</span>
                    <span className="ml-4">Visits: {user._count.serviceVisits}</span>
                ...
                <div className="flex items-center gap-2">
                  ...
                  {user.role === 'ADMIN' && user.email !== 'ayden@yardura.com' && (
                    <Button
                      size="sm"
                      variant="outline"
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-yellow-700 mt-1">
              This panel provides ultimate system control. Actions here can permanently delete data.
              Only the system owner has access to this panel.
            </p>
          </div>
        </div>
      </div>
