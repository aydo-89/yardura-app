...
function OutboundLeadsPageInner() {
  ...
  const beginCreateLead = useCallback((coords?: Coordinates | null) => {
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="text-gray-600">
            Territory canvassing, door-knock tracking, and follow-up workload.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          {isDroppingPin && (
            <div className="absolute top-4 right-4 max-w-xs rounded-xl border border-dashed border-slate-300 bg-white/95 shadow-sm p-4 text-xs text-slate-600 space-y-2">
              ...
              <p>
                Click anywhere on the map to capture coordinates for a new
                prospect. Press “Cancel drop” to exit.
              </p>
            </div>
          )}
      ...
      >
        <SheetContent side="right" className="overflow-y-auto">
          <SheetHeader className="space-y-2">
            ...
            <SheetDescription>
              Capture a door knock, referral, or canvassing lead. Leave email
              blank if unknown and we will track them by address.
            </SheetDescription>
          </SheetHeader>
          <div className="mt-6 space-y-5 pb-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleCreateFieldChange("address", e.target.value)
                }
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleCreateFieldChange("city", e.target.value)
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleCreateFieldChange("state", e.target.value)
                  }
                  placeholder="MN"
                  maxLength={2}
                />
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleCreateFieldChange("zipCode", e.target.value)
                  }
                  placeholder="55419"
                />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleCreateFieldChange("pipelineStage", value)
                  }
                >
                  <SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleCreateFieldChange("territoryId", value)
                  }
                >
                  <SelectTrigger>
...
function OutboundMap({
  ...
  useEffect(() => {
    ...
    const firstWithCoords = leads.find(
  ...
  useEffect(() => {
    ...
    import("maplibre-gl").then((maplibreModule) => {
      ...
      leads.forEach((lead) => {
        ...
        el.style.backgroundColor = stageColorFor(lead.stageColor).includes(
          "emerald",
        )
          ? "#10b981"
      ...
      const recentlyFocused =
        ...
        Date.now() - lastManualFocusRef.current < 1500;
      const shouldAdjustView =
        !(dropMode && dropModeChanged) &&
        !focusTarget &&
        !skipFitRef.current &&
        !recentlyFocused;
