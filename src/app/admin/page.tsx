...
import { Settings, MapPin, DollarSign, BarChart3, Users, Building, Sparkles, Shield, FileText } from 'lucide-react';
      ...
      <div className="container mx-auto p-6 pt-20">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-4xl font-black text-slate-900 tracking-tight">Yardura Service OS</h1>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <div className="flex items-center gap-2 px-4 py-2 bg-blue-50 border border-blue-200 rounded-full">
              ...
              <span className="text-sm font-medium text-blue-800">All Services Active</span>
            </div>
          </div>
        </div>
              ...
              <CardHeader className="relative z-10">
                <CardTitle className="flex items-center gap-4">
                  <div className={`p-4 rounded-2xl shadow-lg transition-all duration-300 group-hover:scale-110 ${
                    index % 6 === 0 ? 'bg-gradient-to-br from-blue-100 to-blue-200 text-blue-600' :
                    index % 6 === 1 ? 'bg-gradient-to-br from-green-100 to-green-200 text-green-600' :
                    index % 6 === 2 ? 'bg-gradient-to-br from-purple-100 to-purple-200 text-purple-600' :
                    index % 6 === 3 ? 'bg-gradient-to-br from-orange-100 to-orange-200 text-orange-600' :
                    index % 6 === 4 ? 'bg-gradient-to-br from-red-100 to-red-200 text-red-600' :
                    'bg-gradient-to-br from-indigo-100 to-indigo-200 text-indigo-600'
                  }`}>
                    <tool.icon className="h-7 w-7" />
                  </div>
                  <div>
                    <div className="text-xl font-bold text-slate-900">{tool.title}</div>
                  </div>
                </CardTitle>
              </CardHeader>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <Link href="/admin/zip-search">
              ...
              >
                ...
                <div className="text-left">
                  <div className="font-semibold text-slate-900">Add ZIP Codes</div>
                  <div className="text-xs text-slate-500">Expand service areas</div>
                </div>
              </Button>
            </Link>
            ...
            <Link href="/admin/pricing">
              ...
              >
                ...
                <div className="text-left">
                  <div className="font-semibold text-slate-900">Update Pricing</div>
                  <div className="text-xs text-slate-500 mt-0.5">Adjust rates & tiers</div>
                </div>
              </Button>
            </Link>
            ...
            <Link href="/admin/zip-search">
              ...
              >
                ...
                <div className="text-left">
                  <div className="font-semibold text-slate-900">Manage ZIP Codes</div>
                  <div className="text-xs text-slate-500 mt-0.5">Add/remove service areas</div>
                </div>
              </Button>
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-center justify-between p-4 bg-white/80 rounded-2xl border border-slate-200">
              <div className="flex items-center gap-3">
                ...
                <span className="font-medium text-slate-900">Business Configuration</span>
              </div>
            ...
            <div className="flex items-center justify-between p-4 bg-white/80 rounded-2xl border border-slate-200">
              <div className="flex items-center gap-3">
                <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse"></div>
                <span className="font-medium text-slate-900">ZIP Eligibility System</span>
              </div>
              <span className="text-green-600 font-bold">Active</span>
            </div>
            ...
            <div className="flex items-center justify-between p-4 bg-white/80 rounded-2xl border border-slate-200">
              <div className="flex items-center gap-3">
                <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse"></div>
                <span className="font-medium text-slate-900">Pricing Engine</span>
              </div>
              <span className="text-green-600 font-bold">Active</span>
            </div>
            ...
            <div className="flex items-center justify-between p-4 bg-white/80 rounded-2xl border border-slate-200">
              <div className="flex items-center gap-3">
                ...
                <span className="font-medium text-slate-900">Multi-tenant Support</span>
              </div>
