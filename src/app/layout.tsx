...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'Yeller' }],
  openGraph: {
    title: 'Yeller by Yardura | Lawngevity through Lawngevity – Minneapolis, MN',
    description:
  ...
  offers: [
    {
      ...
      priceRange: '$20-$24',
      description: 'Weekly monitoring service with AI-powered health insights and early alerts',
    },
    {
      '@type': 'Offer',
      name: 'One-Time Clean',
