...
export const metadata = {
  ...
  description:
    'Expert insights on dog health, eco-friendly waste management, and Minneapolis pet care. Professional dog waste removal tips and local Twin Cities resources.',
  keywords: [
...
const insights = [
  {
    ...
    excerpt:
      "Understanding dog poop colors and what they mean for your pet's health. Learn when to consult your vet about stool changes.",
  ...
  },
  {
    ...
    excerpt:
      'Compare weekly and bi-weekly dog waste removal services. Understand the impact on yard cleanliness, costs, and pet health monitoring.',
    author: 'Mike Chen',
    date: '2024-01-10',
    readTime: '4 min read',
    category: 'Service',
  ...
  },
  {
    ...
    excerpt:
      'Complete guide to Minneapolis dog waste ordinances, penalties, and proper disposal methods. Stay compliant and keep our city clean.',
  ...
  },
  {
    ...
    excerpt:
      'How dog waste contributes to methane emissions and landfill pollution. Learn about eco-friendly disposal and composting solutions.',
      ...
      <div className="bg-white border-b border-accent/10">
        <div className="container py-12">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl font-extrabold text-ink mb-4">Minneapolis Dog Care Insights</h1>
            <p className="text-lg text-muted mb-6">
              Expert advice on dog health, eco-friendly waste management, and local Minneapolis pet
              care resources. Professional insights from veterinarians and environmental experts.
            </p>
            ...
            <Card className="overflow-hidden hover:shadow-xl transition-shadow">
              <div className="md:flex">
                <div className="md:w-1/2 p-8">
                  ...
                  <h2 className="text-2xl font-bold text-ink mb-4">{insights[0].title}</h2>

                  <p className="text-muted mb-6">{insights[0].excerpt}</p>
                ...
                <div className="md:w-1/2 bg-gradient-to-br from-accent-soft/30 to-accent/10 flex items-center justify-center p-8">
                  <div className="text-center">
                    ...
                    <h3 className="text-lg font-semibold text-ink mb-2">Dog Health Matters</h3>
          ...
          <Card className="bg-gradient-to-r from-accent-soft/30 via-white to-accent-soft/30 border-accent/20 max-w-2xl mx-auto">
            <CardContent className="p-8">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <Link href="/quote">
                  <Button className="btn-gradient">Get My Free Quote</Button>
                </Link>
                <Link href="/facts">
                  <Button variant="outline">Learn More About Our Service</Button>
                </Link>
              </div>
            </CardContent>
          </Card>
