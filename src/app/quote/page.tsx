...
export const metadata: Metadata = {
  ...
  description: "Get an instant quote for professional dog waste removal in Minneapolis, Richfield, Edina & Bloomington. Weekly eco-friendly service with health insights.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Instant quotes for eco-friendly dog waste removal. Serving Minneapolis, Richfield, Edina & Bloomington.",
    type: "website",
