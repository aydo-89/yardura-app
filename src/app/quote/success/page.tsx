...
export const metadata: Metadata = {
  ...
  description: "Your dog waste removal quote is confirmed! Check your email for secure login details and schedule your first eco-friendly service visit.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Your eco-friendly dog waste removal service is ready. Check your email for login details.",
    type: "website",
