        ...
        <div className="text-center mb-16">
          <Reveal>
            ...
            <p className="text-responsive-lg text-slate-600 max-w-3xl mx-auto leading-relaxed text-balance">
              Residential weekly/bi-weekly scooping, one-time cleans, and
              premium add-ons. Commercial / HOA services available upon request.
            </p>
          </Reveal>
        ...
        <div className="grid-cards">
            ...
            <Card className="card-modern interactive-hover h-full">
              ...
              <CardContent className="text-slate-600">
                <p className="mb-4 text-sm leading-relaxed">
                  Scheduled cleanup 1x/week (or 2x). Thorough corner-to-corner
                  scan, double-bagging, gate-check, photo-logged pick-ups (for
                  insights).
                </p>
          ...
          <Reveal delay={0.2}>
            <Card className="card-modern interactive-hover h-full">
              ...
              <CardContent className="text-slate-600">
                <p className="mb-4 text-sm leading-relaxed">
                  Professional-grade deodorizing treatment. Choose frequency:
                  first visit only ($25), each visit ($25), or every other visit
                  ($12.50).
                </p>
          ...
          <Reveal delay={0.3}>
            <Card className="card-modern interactive-hover h-full">
              <CardHeader className="pb-6">
                ...
                <CardTitle className="text-xl font-bold text-slate-900">
                  Premium Waste Diversion
                </CardTitle>
              </CardHeader>
              <CardContent className="text-slate-600">
                <p className="mb-4 text-sm leading-relaxed">
                  Go beyond basic eco-friendly disposal. Choose 25% (+$4/visit),
                  50% (+$6/visit), or 100% (+$10/visit) landfill diversion with
        ...
        <div className="mt-20 grid md:grid-cols-2 gap-8">
          <Reveal delay={0.5}>
            <div className="card-modern interactive-hover p-8">
              ...
              <p className="text-slate-600 leading-relaxed">
                Not happy with your first service? We'll make it right or you
                don't pay. No questions asked. Your satisfaction is our top
                priority.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal delay={0.6}>
            <div className="card-modern interactive-hover p-8">
              ...
              <p className="text-slate-600 leading-relaxed">
                We arrive on time, every time. Weather delays are rare, but
                you'll get text updates and rescheduling priority when needed.
              </p>
            </div>
          </Reveal>
        </div>
