    ...
    <section id="eco" className="bg-gradient-to-b from-accent-soft/30 to-white border-t border-b">
      <div className="container py-16">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          ...
          <div ref={wasteRef} className="relative p-8 rounded-3xl border bg-gradient-to-br from-emerald-50 via-emerald-50/80 to-white shadow-soft border-emerald-200/50 hover:shadow-lg transition-all duration-500 hover:scale-[1.02]">
            ...
            <p className="text-sm text-emerald-700 mt-3 font-medium">🌱 From landfills to compost</p>
            <div className="mt-4 bg-emerald-100 rounded-full h-2 overflow-hidden">
              <div className="bg-gradient-to-r from-emerald-400 to-emerald-600 h-2 rounded-full transition-all duration-2000 ease-out" style={{width: '32%'}}></div>
            </div>
          </div>

          {/* Methane Avoided: sky blue theme */}
          <div ref={methaneRef} className="relative p-8 rounded-3xl border bg-gradient-to-br from-sky-50 via-sky-50/80 to-white shadow-soft border-sky-200/50 hover:shadow-lg transition-all duration-500 hover:scale-[1.02]">
            <div className="absolute top-4 right-4">
            ...
            <div className="mt-4 bg-sky-100 rounded-full h-2 overflow-hidden">
              <div className="bg-gradient-to-r from-sky-400 to-sky-600 h-2 rounded-full transition-all duration-2000 ease-out" style={{width: '28%'}}></div>
            </div>
          </div>

          {/* Compost Created: amber/orange theme */}
          <div ref={compostRef} className="relative p-8 rounded-3xl border bg-gradient-to-br from-amber-50 via-amber-50/80 to-white shadow-soft border-amber-200/50 hover:shadow-lg transition-all duration-500 hover:scale-[1.02]">
            <div className="absolute top-4 right-4">
            ...
            <p className="text-sm text-amber-700 mt-3 font-medium">🌿 Nutrient-rich soil amendment</p>
            <div className="mt-4 bg-amber-100 rounded-full h-2 overflow-hidden">
              <div className="bg-gradient-to-r from-amber-400 to-amber-600 h-2 rounded-full transition-all duration-2000 ease-out" style={{width: '24%'}}></div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl border border-accent/20 p-8 shadow-soft">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="text-center">
              ...
              <div className="text-2xl font-bold text-accent mb-2">4 Service Areas</div>
              <p className="text-muted">South Minneapolis, Richfield, Edina, Bloomington</p>
            </div>
            <div className="text-center">
