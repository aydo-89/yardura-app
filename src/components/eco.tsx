        ...
        <div className="text-center mb-20">
          <div className="relative">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
              Efficient waste management that's good for your yard and the environment
            </p>
          </div>
          ...
          <div className="relative rounded-2xl overflow-hidden mt-16 mb-12 shadow-xl max-w-4xl mx-auto">
            ...
            <div className="absolute bottom-4 left-6 text-white">
              ...
              <p className="text-sm opacity-90">Sustainable practices for a cleaner environment</p>
            </div>
          </div>
            ...
            <div className="space-y-8">
              <div className="text-slate-700 max-w-xl text-responsive-lg leading-relaxed space-y-6">
                <p className="text-balance">
                  Your dog's waste doesn't have to be a neighborhood problem. We transform that <span className="font-bold text-gradient">250 lbs per year</span> into nutrient-rich compost—keeping your yard pristine while contributing to a cleaner environment and supporting local sustainable initiatives.
                </p>
                <p className="text-balance">
                  Add our natural deodorizing treatment to eliminate odors and create a fresher, more enjoyable outdoor space for your entire family to relax and play.
                </p>
              </div>
              ...
              <div className="card-modern p-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="text-center p-4 bg-gradient-to-br from-green-100/50 to-green-200/30 rounded-2xl border border-green-700/20 shadow-sm">
                    <div className="font-bold text-green-700 text-lg mb-2">Weekly</div>
                    <div className="text-sm text-slate-600 font-medium">Most popular</div>
                  </div>
                  <div className="text-center p-4 bg-white/80 rounded-2xl border border-slate-200/60 shadow-sm">
                    <div className="font-bold text-slate-800 text-lg mb-2">Bi-weekly</div>
                    <div className="text-sm text-slate-600 font-medium">Every 2 weeks</div>
                  </div>
                  <div className="text-center p-4 bg-white/80 rounded-2xl border border-slate-200/60 shadow-sm">
                    <div className="font-bold text-slate-800 text-lg mb-2">2x Weekly</div>
                    <div className="text-sm text-slate-600 font-medium">2x per week</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="text-center p-4 bg-white/80 backdrop-blur-sm rounded-2xl border border-emerald-200/30 shadow-card interactive-hover">
                  ...
                  <div className="text-gradient text-lg font-black mb-1">847 lbs</div>
                  <div className="text-xs text-emerald-700 font-medium">Diverted</div>
                </div>
                ...
                <div className="text-center p-4 bg-white/80 backdrop-blur-sm rounded-2xl border border-teal-200/30 shadow-card interactive-hover">
                  ...
                  <div className="text-gradient text-lg font-black mb-1">403 ft³</div>
                  <div className="text-xs text-teal-700 font-medium">Emissions avoided</div>
                </div>
                ...
                <div className="text-center p-4 bg-white/80 backdrop-blur-sm rounded-2xl border border-cyan-200/30 shadow-card interactive-hover">
                  ...
                  <div className="text-gradient text-lg font-black mb-1">592 lbs</div>
                  <div className="text-xs text-cyan-700 font-medium">Compost created</div>
                </div>
              </div>
              ...
              <div className="card-modern p-6 bg-gradient-to-br from-emerald-50/90 via-green-50/50 to-emerald-100/70 border-emerald-200/30">
                <h4 className="text-lg font-bold text-emerald-800 mb-3">Premium Diversion Options</h4>
                <p className="text-sm text-emerald-700 leading-relaxed">
                  Choose 25%, 50%, or 100% diversion to support local composting initiatives and track your environmental impact.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 pt-8 border-t border-green-700/20">
            <div className="text-center">
              <div className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-br from-teal-50/90 via-green-100/40 to-teal-100/70 rounded-2xl border border-teal-200/30 mb-6 shadow-sm">
                ...
                <span className="text-lg font-bold text-teal-800">Optional Add-ons</span>
              </div>
              <p className="text-slate-600 text-lg leading-relaxed max-w-4xl mx-auto text-balance">
                Enhance your service with eco-friendly deodorizing treatment to naturally neutralize odors
                without harsh chemicals. Track your environmental impact through your personalized dashboard.
              </p>
            </div>
          </div>
        </div>
