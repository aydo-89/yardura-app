...
export default function WhyItMatters({
  ...
  const { ref: insightRef, count: insightCount } = useInViewCountUp({
    end: 24,
    duration: 2000,
  });
        ...
        >
          <div className="relative">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
              Smart technology that helps you stay ahead of potential health
              issues
            </p>
          </div>
        </MotionDiv>
            ...
            <div className="absolute inset-0 flex items-center justify-start pl-8 md:pl-16">
              <div className="text-white max-w-lg">
                ...
                <p className="text-lg opacity-90">
                  Stay informed, stay ahead of potential health issues
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <p className="mt-10 text-responsive-lg text-slate-600 leading-relaxed text-balance">
                Your dog's health tells a story through their waste. Small
                changes in color, consistency, or frequency can be early
                indicators that help you stay ahead of potential issues. Our
                smart monitoring gives you insights that busy pet parents might
                otherwise miss.
              </p>
                ...
                <div>
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <h3 className="text-2xl font-black text-green-600">
                      Yeller's Smart Approach
                    </h3>
                  </div>
                  <p className="text-slate-700 font-medium text-lg leading-relaxed">
                    We combine reliable yard cleaning with optional health
                    insights, giving you peace of mind and valuable information
                    to share with your vet during regular checkups.
                  </p>
                </div>
              </MotionDiv>
            </MotionDiv>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-green-700 leading-relaxed">
                    Most pet owners don't inspect every stool—it's
                    understandable! But small changes can signal bigger issues.
                    We capture the details you might miss, so you get peace of
                    mind without the hassle.
                  </p>
                </div>
              </div>
            </MotionDiv>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-green-700 font-medium">
                    Spot parasites and digestive issues before symptoms show
                  </span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-green-700 rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-green-700 font-medium">
                    Track changes in stool color, consistency, and patterns
                  </span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-green-700 rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-green-700 font-medium">
                    Get alerts about concerning trends in your dog's health
                  </span>
                </div>
              </div>
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-green-700 rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-green-700 font-medium">
                    Dark/black blood: May indicate upper digestive issues
                  </span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-green-700 rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-green-700 font-medium">
                    Early warning signs help prevent serious complications
                  </span>
                </div>
              </div>
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-green-700 rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-green-700 font-medium">
                    Professional monitoring without you having to look
                  </span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-green-700 rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-green-700 font-medium">
                    Smart alerts that learn your dog's normal patterns
                  </span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-green-700 rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-green-700 font-medium">
                    Your privacy protected with opt-in, secure data handling
                  </span>
                </div>
              </div>
              ...
              <div className="mt-6 p-3 bg-green-700/10 rounded-xl border border-green-700/20">
                <p className="text-sm text-green-800 font-semibold">
                  Rest easy knowing we're watching
                </p>
              </div>
            </MotionDiv>
          </div>
        ...
        <MotionDiv variants={itemVariants} className="text-center mt-16">
          <div className="bg-gradient-to-br from-white via-green-50/20 to-green-100/30 rounded-3xl p-8 max-w-2xl mx-auto shadow-floating border border-green-700/10">
            ...
            <p className="text-slate-600 mb-8 text-lg leading-relaxed">
              Join Twin Cities families who trust us with their yard care and
              peace of mind
            </p>
            ...
            <p className="text-slate-500 mt-6 text-sm">
              Health insights are informational only. Always consult your vet
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-slate-50/50 rounded-xl p-6 border border-slate-100">
              ...
              <div className="text-xs text-slate-600 leading-relaxed space-y-2 max-w-3xl mx-auto">
                <p>
                  <strong>
                    Health insights provided by Yeller are for informational
                    purposes only
                  </strong>{" "}
                  and do not constitute veterinary advice, diagnosis, or
                  treatment recommendations. Our monitoring technology helps
                  identify patterns that may warrant professional veterinary
                  attention.
                </p>
                <p>
                  Yeller does not diagnose, treat, cure, or prevent any medical
                  conditions. All health-related decisions should be made in
                  consultation with a qualified veterinarian. If you have
                  concerns about your pet's health, please contact your
