...
export default function StructuredData({ type = 'homepage', data }: StructuredDataProps) {
  ...
  const getStructuredData = () => {
    ...
    const localBusinessData = {
      ...
      "@type": "LocalBusiness",
      "name": "Yardura",
      "description": "Tech-enabled, eco-friendly dog waste removal with smart health insights. Serving Minneapolis, Richfield, Edina & Bloomington.",
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "itemOffered": {
              ...
              "description": "Professional bi-weekly dog waste removal in Minneapolis with 5% discount"
            },
            "priceRange": "$19-$33",
            "availability": "https://schema.org/InStock",
            "areaServed": {
    ...
    const websiteData = {
      ...
      "name": "Yardura",
      "url": "https://www.yardura.com",
      "description": "Minneapolis dog waste removal with eco-friendly disposal and AI health insights",
      "publisher": {
        "@type": "LocalBusiness",
        "name": "Yardura"
      },
    ...
    const breadcrumbData = pathname !== '/' ? {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 2,
          "name": pathname === '/quote' ? 'Get Quote' :
                  pathname === '/insights' ? 'Health Insights' :
                  pathname === '/facts' ? 'Service Facts' :
    ...
    const articleData = type === 'article' ? {
      "@context": "https://schema.org",
      "@type": "Article",
      "headline": data?.title || "Dog Health Insights",
      "description": data?.excerpt || "Professional insights on dog health and waste analysis",
      "author": {
        "@type": "Person",
        "name": data?.author || "Yardura Team"
      },
      "publisher": {
        "@type": "Organization",
        "name": "Yardura",
      ...
      "datePublished": data?.date || "2024-01-15",
      "dateModified": data?.date || "2024-01-15",
      "mainEntityOfPage": {
        "@type": "WebPage",
