...
import { toneForStatus, COLOR_HEX, CONS_HEX, type WeekRollup } from '@/shared/wellness';
...
export const WeeklyDetailsGrid: React.FC<WeeklyDetailsGridProps> = ({ weeks }) => {
  ...
  const getConsistencyColor = (key: string) => {
    switch (key) {
      case 'normal': return COLOR_HEX.normal;
      case 'soft': return CONS_HEX.soft;
      case 'dry': return '#d97706';
      default: return COLOR_HEX.normal;
    }
  };
  ...
  return (
    <Disclosure title="Detailed Week-by-Week Analysis" defaultOpen={false}>
                ...
                <CardContent className="p-4">
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                      ...
                      <StatusPill status={week.healthStatus} />
                    </div>
                  ...
                  <div className="mb-3">
                    ...
                    <div className="space-y-1">
                      {Object.entries(week.consistency).map(([key, count]) => {
                        ...
                        const percentage = week.deposits > 0 ? Math.round((count / week.deposits) * 100) : 0;
                        return (
                  ...
                  {(week.colors.red > 0 || week.colors.black > 0) && (
                    <div className="pt-2 border-t border-slate-200">
                      <Button variant="outline" size="sm" asChild className="text-xs w-full">
                        <a href={`/reports?filter=critical&week=${week.start.toISOString().split('T')[0]}`}>
