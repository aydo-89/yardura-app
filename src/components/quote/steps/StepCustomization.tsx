...
export const StepCustomization: React.FC<StepProps> = ({
    ...
    try {
      ...
      console.log(
        ...
        config.basePricing.addOns.find((a: any) => a.id === "spray-deck")
          ?.priceCents,
        "litter:",
        config.basePricing.addOns.find((a: any) => a.id === "litter")
          ?.priceCents,
      );
        ...
        .forEach((addon: AddOnConfig) => {
          ...
          if (addon.id.startsWith("divert-")) {
            if (addon.id === "divert-takeaway") {
              ...
              modes[addon.id] =
                quoteData?.addOns?.divertMode === "25" ? "selected" : "none";
            } else if (addon.id === "divert-50") {
              modes[addon.id] =
                quoteData?.addOns?.divertMode === "50" ? "selected" : "none";
            } else if (addon.id === "divert-100") {
              modes[addon.id] =
                quoteData?.addOns?.divertMode === "100" ? "selected" : "none";
            }
          } else {
  ...
  const handleAddonModeChange = (addonId: string, mode: string) => {
    ...
    if (addonId.startsWith("divert-")) {
      ...
      if (addonId === "divert-takeaway" && mode === "selected")
        divertMode = "takeaway";
      else if (addonId === "divert-25" && mode === "selected")
        divertMode = "25";
      else if (addonId === "divert-50" && mode === "selected")
        divertMode = "50";
      else if (addonId === "divert-100" && mode === "selected")
        divertMode = "100";
      ...
      const writeModeKey =
        addonId === "spray-deck" ? "sprayDeckMode" : `${addonId}Mode`;
  ...
  const renderAddonSection = (addon: AddOnConfig, index: number) => {
    ...
    if (addon.id === "deodorize") {
      ...
      colorClasses =
        "text-blue-800 bg-gradient-to-br from-blue-100 to-blue-200";
      cardColorClasses =
        "ring-blue-500 bg-gradient-to-br from-blue-50 to-blue-100";
    } else if (addon.id.startsWith("divert-")) {
      icon = <Recycle className="w-5 h-5 text-green-600" />;
      colorClasses =
        "text-green-800 bg-gradient-to-br from-green-100 to-green-200";
      cardColorClasses =
        "ring-green-500 bg-gradient-to-br from-green-50 to-emerald-50";
    }
    ...
    return (
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3
              className={`text-lg font-semibold ${colorClasses.includes("purple") ? "text-purple-800" : colorClasses.includes("blue") ? "text-blue-800" : colorClasses.includes("green") ? "text-green-800" : "text-gray-800"}`}
            >
              {addon.name}
            </h3>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        {option.selected && (
                          <CheckCircle
                            className={`w-4 h-4 ${colorClasses.includes("purple") ? "text-purple-600" : colorClasses.includes("blue") ? "text-blue-600" : colorClasses.includes("green") ? "text-green-600" : "text-gray-600"}`}
                          />
                        )}
                      </div>
                    ...
                    >
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <div className="text-right ml-4">
                          <div
                            className={`px-3 py-1 rounded-full ${addon.id === "deodorize" ? "bg-green-700/10" : "bg-emerald-100"}`}
                          >
                            <div
                              className={`font-bold text-lg ${addon.id === "deodorize" ? "text-green-700" : "text-emerald-700"}`}
                            >
                              +${(addon.priceCents / 100).toFixed(2)}
                            </div>
                            <div
                              className={`text-xs ${addon.id === "deodorize" ? "text-green-700/70" : "text-emerald-600"}`}
                            >
                              per visit
                            </div>
                          </div>
                        ...
                        {quoteData?.frequency === "one-time" ? (
                          ...
                          <div className="grid grid-cols-1 gap-3">
                            <motion.button
                              ...
                              whileTap={{ scale: 0.98 }}
                              onClick={() =>
                                handleAddonModeChange(addon.id, "one-time")
                              }
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <span className="font-medium">
                                  Yes, add {addon.name.toLowerCase()}
                                </span>
                            ...
                            <motion.button
                              ...
                              whileTap={{ scale: 0.98 }}
                              onClick={() =>
                                handleAddonModeChange(addon.id, "none")
                              }
                              className={`p-4 border-2 rounded-lg text-left transition-all duration-200 ${
                                currentMode === "none"
                                  ? `border-green-700 bg-green-700/10 shadow-md`
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <span className="font-medium">
                                  No {addon.name.toLowerCase()} needed
                                </span>
                          ...
                          <div className="grid grid-cols-1 gap-3">
                            <motion.button
                              ...
                              whileTap={{ scale: 0.98 }}
                              onClick={() =>
                                handleAddonModeChange(addon.id, "first-visit")
                              }
                              className={`p-4 border-2 rounded-lg text-left transition-all duration-200 ${
                            ...
                            >
                              ...
                              <div className="text-xs text-muted mt-1">
                                Perfect for one-time deep clean
                              </div>
                            </motion.button>
                            ...
                            <motion.button
                              ...
                              whileTap={{ scale: 0.98 }}
                              onClick={() =>
                                handleAddonModeChange(addon.id, "each-visit")
                              }
                              className={`p-4 border-2 rounded-lg text-left transition-all duration-200 ${
                            ...
                            >
                              <div className="flex items-center justify-between">
                                ...
                                <span className="text-teal-700 font-bold">
                                  +${(addon.priceCents / 100).toFixed(2)} per
                                  visit
                                </span>
                              </div>
                              <div className="text-xs text-muted mt-1">
                                Continuous freshness & odor control
                              </div>
                            </motion.button>
                            ...
                            <motion.button
                              ...
                              whileTap={{ scale: 0.98 }}
                              onClick={() =>
                                handleAddonModeChange(addon.id, "every-other")
                              }
                              className={`p-4 border-2 rounded-lg text-left transition-all duration-200 ${
                            ...
                            >
                              <div className="flex items-center justify-between">
                                ...
                                <span className="text-teal-700 font-bold">
                                  +$
                                  {(
                                    Math.round(addon.priceCents / 2) / 100
                                  ).toFixed(2)}{" "}
                                  per visit
                                </span>
                              </div>
                  ...
                  >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="mb-3 p-3 bg-green-50 border border-green-200 rounded-lg break-words">
                          <p className="text-sm text-green-800 font-medium mb-1">
                            🌍 All "Take Away" options remove 100% of your pet
                            waste
                          </p>
                          <p className="text-sm text-green-700">
                            The difference is how much gets diverted from
                            landfill to compost, creating positive environmental
                            impact.
                          </p>
                        </div>
                        <p className="text-sm text-muted-foreground leading-relaxed break-words">
                          Track your environmental impact on your dashboard: lbs
                          diverted, methane avoided, compost created
                        </p>
                      </div>
                      <div className="sm:text-right sm:ml-4 mt-2 sm:mt-0 flex-shrink-0">
                        {(() => {
                          const prices = groupedAddOns.waste.map(
                            (a) => a.priceCents / 100,
                          );
                    ...
                    <div className="grid gap-3">
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        onClick={() =>
                          handleAddonModeChange("divert-none", "selected")
                        }
                        className={`p-4 border-2 rounded-lg text-left transition-all duration-200 ${
                          !groupedAddOns.waste.some(
                            (addon) => addonModes[addon.id] === "selected",
                          )
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <span className="font-medium">
                            Leave waste in my bin
                          </span>
                          <span className="text-muted-foreground">Free</span>
                        </div>
                        <div className="text-xs text-muted mt-1">
                          Standard disposal service
                        </div>
                      </motion.button>
                    ...
                    <div className="mt-4 p-3 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg">
                      ...
                      <p className="text-sm text-green-700 mt-1">
                        Monitor your carbon footprint reduction and compost
                        contribution on your dashboard
                      </p>
                    </div>
                  </motion.div>
                )}
                ...
                {groupedAddOns.other.map((addon, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      transition={{
                        delay: (groupedAddOns.cleaning.length + index) * 0.1,
                      }}
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-700 mt-1">
                        Biodegradable bags and eco-friendly deodorizing
                        practices included with every service. Premium waste
                        diversion options available to maximize your
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) =>
                      updateQuoteData({ specialInstructions: e.target.value })
                    }
