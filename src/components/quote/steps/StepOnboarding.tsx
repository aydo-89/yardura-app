        ...
        <CardContent className="space-y-8">
            ...
            {microbiomeServices.length > 0 && (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <Label className="text-xl font-semibold text-teal-800">Gut Health Analysis</Label>
                </div>
                <div className="grid gap-4">
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="text-lg font-semibold text-amber-800 mb-2">Coming Soon Features</p>
          ...
          {quoteData.premiumOnboarding && quoteData.premiumOnboarding !== 'none' && (
            ...
            >
              <div className="text-sm text-muted-foreground mb-2">Welcome Package Investment</div>
              ...
              <div className="text-xs text-muted-foreground">Ships after your first visit</div>
            </motion.div>
          )}
        </CardContent>
      </Card>
