...
function DifferentiatorCard({
  ...
  return (
    <div className="group relative">
      <div className={`absolute inset-0 bg-gradient-to-br ${colors.hoverBg} rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-xl`} />
      <div className={`relative card-modern p-8 interactive-hover border ${colors.border}`}>
        <div className="flex items-start gap-6">
          <div className={`p-4 rounded-2xl bg-gradient-to-br ${colors.iconBg} ${color} relative shadow-sm`}>
          ...
          <div className="flex-1">
            ...
            {comingSoon && (
              <div className="mt-4 inline-flex items-center gap-2 px-4 py-2 bg-green-700/10 rounded-2xl border border-green-700/20 shadow-sm">
                ...
                <span className="text-sm font-semibold text-green-700">Coming Soon</span>
              </div>
            )}
          </div>
        </div>
          ...
          <div className="relative rounded-3xl overflow-hidden mb-16 shadow-2xl">
            ...
            <div className="absolute inset-0 flex items-center justify-start pl-8 md:pl-16">
              <div className="text-white max-w-lg">
                <h3 className="text-2xl md:text-3xl font-bold mb-3">Technology Meets Care</h3>
                <p className="text-lg opacity-90">Smart insights that help you stay ahead of potential health issues</p>
              </div>
            </div>
          </div>
        </Reveal>
          ...
          <div className="text-center mt-16">
            <div className="bg-white/90 backdrop-blur-md border border-green-700/20 rounded-3xl p-8 shadow-card max-w-4xl mx-auto">
              <p className="text-lg text-slate-700 font-medium max-w-3xl mx-auto leading-relaxed">
                <strong className="text-gradient text-xl">Experience the difference:</strong> Professional service meets cutting-edge
