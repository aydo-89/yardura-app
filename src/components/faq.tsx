              ...
              {[
                {
                  ...
                  answer: "We currently serve South Minneapolis, Richfield, Edina, and Bloomington. Nearby areas may be available as we expand—ask when you request a quote.",
                  category: "service"
                },
                {
                  id: "item-2",
                  ...
                  answer: "No contracts. You can pause, skip, or cancel anytime. We just ask for a quick heads up so we can update your route.",
                  category: "service"
                },
                {
                  id: "item-3",
                  ...
                  answer: "We use a transparent pricing matrix starting at $20/weekly for 1 dog (medium yard). Price increases with dog count ($4 each additional dog) and yard size. Basic health insights are included at no extra cost. Premium eco diversion options are available as add-ons.",
                  category: "pricing"
                },
                {
                  id: "item-4",
                  ...
                  answer: "We're pet-friendly. If your dog is comfortable with visitors, we'll proceed. Otherwise, you can secure your pup or we'll coordinate a revisit.",
                  category: "service"
                },
                {
                  id: "item-5",
                  ...
                  answer: "If you opt in, we collect anonymized stool photos and notes to build baselines for the 3 C's (Color, Content, Consistency). Alerts are informational only and not veterinary advice.",
                  category: "insights"
                },
                {
                  id: "item-6",
                  ...
                  answer: "EOW service costs 25% more per visit because two weeks of waste accumulation requires longer service time and creates less route efficiency. However, your monthly total is lower due to fewer visits.",
                  category: "pricing"
                },
                {
                  id: "item-7",
                  ...
                  answer: "Basic eco-friendly disposal is included in our core service at no extra cost - we always use biodegradable plastic bags and eco-friendly deodorizing practices, leaving waste in your bin. Premium diversion options (25%, 50%, or 100% diversion) are available for +$4-$10 per visit to fund expansion of our eco-program.",
                  category: "eco"
                },
                {
                  id: "item-8",
                  ...
                  answer: "Basic health insights (3 C's monitoring) are included at no extra cost. A premium Insights Plus tier may be available later for advanced analytics, export features, and priority support.",
                  category: "insights"
                },
                {
                  id: "item-9",
                  ...
                  answer: "We're piloting composting/conditioning routes to keep waste out of landfills and reduce methane. Your dashboard will estimate impact as the program expands.",
                  category: "eco"
                },
                {
                  id: "item-9.5",
                  ...
                  answer: "Premium diversion options (25%, 50%, or 100% diversion) require additional processing, transportation, and infrastructure. These charges help fund expansion of our eco-program while keeping our core service affordable. All diversion levels provide dashboard tracking of your environmental impact.",
                  category: "eco"
                },
                {
                  id: "item-10",
                  ...
                  answer: "We scoop in most weather. In heavy snowfall or unsafe conditions, we'll reschedule and catch up on the next visit.",
                  category: "service"
                },
                {
                  id: "item-11",
                  ...
                  answer: "Click 'Get My Quote', fill in your details and preferences, and we'll confirm schedule and price by text/email.",
                  category: "service"
                }
              ].map((faq, index) => (
                <AccordionItem
          ...
          <div className="text-center mt-20">
            <div className="bg-gradient-to-br from-emerald-50/90 via-green-50/50 to-emerald-100/70 border border-emerald-200/30 rounded-3xl p-10 shadow-card max-w-4xl mx-auto">
              <div className="flex items-center justify-center gap-4 mb-6">
                ...
                <h3 className="text-3xl font-black text-slate-900">Still have questions?</h3>
              </div>
              <p className="text-slate-600 text-lg mb-8 leading-relaxed max-w-2xl mx-auto">
                Can't find what you're looking for? Our team is here to help you choose the perfect service for your needs.
              </p>
