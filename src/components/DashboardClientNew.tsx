    ...
    <div className="space-y-6">
      ...
      >
        <TabsList className="grid w-full grid-cols-8 bg-slate-100 p-1 rounded-xl">
          <TabsTrigger
            value="overview"
            className="rounded-lg data-[state=active]:bg-white data-[state=active]:shadow-lg transition-all duration-200"
          >
          ...
          {(() => {
            ...
            for (let i = 0; i < 8; i++) {
              ...
              if (softShare >= 0.3) {
                softWeeks++;
                consecutiveHighSoft++;
                maxConsec = Math.max(maxConsec, consecutiveHighSoft);
              } else {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex gap-2">
                        ...
                        {alertWeeks > 0 && (
                          <a
                            href={`/reports?filter=critical&weeks=${alertWeeks}`}
                          ...
                          <div className="space-y-1 text-slate-600">
                            ...
                            {recentWeeks.some((w) => w.deposits === 0) && (
                              <div className="text-amber-600">
                                • Some weeks with no activity detected
                              </div>
                            )}
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="text-slate-600 space-y-1">
                            ...
                            {colorStats.yellow.count > 0 && (
                              <div className="text-amber-600">
                                • Yellow/gray may indicate liver issues
                              </div>
                            )}
                            {colorStats.red.count === 0 &&
                              colorStats.black.count === 0 &&
                          ...
                          <div>
                            ...
                            <div className="text-slate-600 space-y-1">
                              {consistencyStats.dry.count > 0 && (
                                <div className="text-amber-600">
                                  • Dry/hard consistency may warrant monitoring
                                </div>
                              )}
                              {consistencyStats.soft.count > 0 && (
                                <div className="text-amber-600">
                                  • Soft consistency detected - monitor closely
                                </div>
                              )}
                              {consistencyStats.dry.count === 0 &&
                                consistencyStats.soft.count === 0 && (
                                  <div className="text-green-600">
                                    • No concerning consistency changes detected
                                  </div>
                                )}
                            </div>
                          </div>
              ...
              <CardContent>
                {(() => {
                  ...
                  for (let i = 0; i < 8; i++) {
                    ...
                    const inWeek = dataReadings.filter((r) => {
                      const t = new Date(r.timestamp);
        ...
        <TabsContent value="billing" className="space-y-6">
          <Card className="motion-hover-lift">
            ...
            <CardContent>
              ...
              <div className="mt-4">
                <a className="text-sm text-accent underline" href="/billing">
                  Open Stripe Portal
                </a>
              </div>
            </CardContent>
                  ...
                  <>
                    <div className="grid gap-4">
                      {dogsState.map((dog, index) => (
                        <div
                          key={dog.id}
                          className="relative overflow-hidden rounded-xl bg-gradient-to-r from-green-50 to-emerald-50 p-6 border border-green-200"
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
