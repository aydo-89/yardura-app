...
export default function SignUpPage() {
  ...
  const handleSignUp = async () => {
    ...
    try {
      ...
      toast.success('Account created successfully! Welcome to Yardura.');
    ...
    <div className="min-h-screen bg-gradient-to-b from-brand-50 to-white py-12">
      <div className="container max-w-md mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-extrabold text-ink mb-4">Create Your Account</h1>
          <p className="text-slate-600">Get started with Yardura in just 30 seconds</p>
        </div>
