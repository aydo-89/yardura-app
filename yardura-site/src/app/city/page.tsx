          ...
          <Reveal>
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted max-w-3xl mx-auto">
                ...
                perfect service for your Minneapolis, St. Cloud, or surrounding area.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal>
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted max-w-2xl mx-auto">
                We serve select Twin Cities communities with reliable, eco-friendly dog waste
                removal services.
              </p>
            </div>
          </Reveal>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-soft">
                ...
                <div className="mt-6 p-4 bg-accent/10 rounded-xl">
                  <p className="text-sm text-center">
                    <strong>Serving:</strong> {cities.map((c) => c.displayName).join(', ')} & surrounding areas
                  </p>
                </div>
              </div>
            </Reveal>
