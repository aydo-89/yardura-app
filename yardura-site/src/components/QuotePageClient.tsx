            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-amber-700">
                  Wellness insights are launching soon! New subscribers get 90 days free, then just $59.99/month to continue.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-blue-700">
                  ...
                  New subscribers get 90 days free, then just $59.99/month to continue. We
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mt-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                />
                <div className="flex-1">
                  <Label htmlFor="data-optin" className="text-sm font-medium text-amber-800 cursor-pointer">
                    Help improve wellness accuracy
                  </Label>
                  <p className="text-xs text-amber-700 mt-1">
                    Share anonymized wellness data to help us improve the accuracy of our upcoming wellness insights
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                />
                <div className="flex-1">
                  <Label htmlFor="wellness-waitlist" className="text-sm font-medium text-amber-800 cursor-pointer">
