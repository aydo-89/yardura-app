  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-8 text-white shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            />
            <div>
              <div className="font-extrabold text-2xl text-white">Yardura</div>
              <div className="text-sm text-slate-300">Clean yards. Smarter insights. Less landfill</div>
            </div>
          </div>
      ...
      <Tabs
        ...
        className="space-y-6"
      >
        <TabsList className="grid w-full grid-cols-6 bg-gradient-to-r from-slate-50 via-white to-slate-50 p-1 rounded-xl border border-accent/10 shadow-soft">
          <TabsTrigger
            value="overview"
            className="rounded-lg data-[state=active]:bg-accent data-[state=active]:text-white data-[state=active]:shadow-lg transition-all duration-200 hover:bg-accent-soft/50 hover:text-accent font-medium"
          >
            Overview
          </TabsTrigger>
          <TabsTrigger
        ...
        <TabsContent value="wellness" className="space-y-6">
          <WellnessTab dataReadings={dataReadings} serviceVisits={serviceVisits} />
        </TabsContent>
