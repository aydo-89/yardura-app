    ...
    <div className="space-y-6">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-slate-600 max-w-2xl mx-auto">
          Track your positive environmental contribution through waste diversion and reduced emissions
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <div className="text-2xl font-bold text-slate-900">{methaneThisMonthLbsEq.toFixed(1)}</div>
      ...
      <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl border border-green-200 p-6">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="text-center">
            ...
            <div className="text-2xl font-bold text-slate-900 mb-1">{carMilesEquivalent.toLocaleString()}</div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-slate-600">Upgrade to composting or other diversion options for maximum impact</div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-slate-600">Use biodegradable bags and natural cleaning products</div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-slate-600">Share your impact story to inspire others</div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-slate-600">Monitor your dashboard to see growing impact over time</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-r from-accent/5 to-accent-soft/5 rounded-xl border border-accent/20 p-6">
        <div className="text-center">
          ...
          <h3 className="text-lg font-semibold text-slate-900 mb-2">Thank You for Making a Difference</h3>
          <p className="text-slate-600 text-sm max-w-md mx-auto">
            Your commitment to waste diversion helps create a cleaner, greener community.
            Together, we're building a more sustainable future for our neighborhoods.
          </p>
        </div>
      </div>
    </div>
