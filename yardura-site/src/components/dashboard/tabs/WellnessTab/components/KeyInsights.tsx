  ...
  return (
    ...
    >
      <CardContent className="p-6">
        <h3 className="text-lg font-semibold text-slate-900 mb-4">What we're seeing</h3>
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-start gap-3 mt-4 pt-4 border-t border-slate-200">
            <Activity
              ...
              style={{ color: wellnessTheme.teal }}
            />
            <div className="text-slate-700">
              <strong>{totalDeposits4w} deposits</strong> tracked over 4 weeks, with{' '}
              <strong>
                {weeksWithIssues} week{weeksWithIssues !== 1 ? 's' : ''}
              </strong>{' '}
              showing patterns worth noting.
            </div>
          </div>
        </div>
      </CardContent>
