...
export const WellnessTab: React.FC<WellnessTabProps> = ({
  ...
  const handleJoinWaitlist = async (email: string) => {
    ...
    setTimeout(() => {
      alert(`Thank you for joining the waitlist! We'll notify you at ${email} when advanced wellness insights are available.`);
    }, 500);
  };
            ...
            <ColorAnalysis
              colorStats={{
                normal: {
                  ...
                  pct: totalColorCount > 0 ? Math.round((wellnessData.trends.colorDonut.normal / totalColorCount) * 100) : 0
                },
                yellow: {
                  count: wellnessData.trends.colorDonut.yellow,
                  pct: totalColorCount > 0 ? Math.round((wellnessData.trends.colorDonut.yellow / totalColorCount) * 100) : 0
                },
                red: {
                  count: wellnessData.trends.colorDonut.red,
                  pct: totalColorCount > 0 ? Math.round((wellnessData.trends.colorDonut.red / totalColorCount) * 100) : 0
                },
                black: {
                  count: wellnessData.trends.colorDonut.black,
                  pct: totalColorCount > 0 ? Math.round((wellnessData.trends.colorDonut.black / totalColorCount) * 100) : 0
                },
              }}
