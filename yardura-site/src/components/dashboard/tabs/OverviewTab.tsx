...
import type { User, Dog, ServiceVisit, DataReading } from '../types';
...
export default function OverviewTab(props: OverviewTabProps) {
  ...
  const handleJoinWellnessWaitlist = async (email: string) => {
    ...
    setTimeout(() => {
      alert(`Thank you for joining the wellness waitlist! We'll notify you at ${email} when advanced wellness insights are available.`);
    }, 500);
  };
