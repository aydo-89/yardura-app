...
export default function Insights({ dataReadings = [], serviceVisits = [] }: InsightsProps = {}) {
  ...
  const wellnessData = useWellnessData(
    dataReadings.length > 0 ? dataReadings : [
  ...
  const alerts = [
    {
      ...
      message: "Possible fresh blood detected in stool. This requires immediate veterinary attention.",
      time: '1 day ago',
      color: 'red',
    },
    {
    ...
    },
    {
      ...
      message: "Stool consistency suggests mild dehydration. Ensure fresh water is always available.",
      time: '1 week ago',
      color: 'blue',
    },
    {
                        ...
                        <div className="flex items-start gap-2">
                          <div
                            className={`size-2 rounded-full mt-2 ${
                              ...
                              alert.color === 'red' ? 'bg-red-500' : 'bg-emerald-500'
                            }`}
                          ></div>
                          <div className="flex-1">
                            <div
                              className={`text-sm font-medium ${
                                ...
                                alert.color === 'red' ? 'text-red-800' : 'text-emerald-800'
                              }`}
                            >
                              {alert.title}
                            </div>
                      ...
                      {[
                        ...
                        return (
                          <g key={index}>
                            ...
                            {/* Data point */}
                            <circle cx={x} cy={y} r="5" fill={color} className="drop-shadow-sm">
                              <title>
        ...
        <Reveal delay={0.7}>
          <div className="mt-16 text-center">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-ink mb-2">Join the Waitlist for Wellness Insights</h3>
              <p className="text-muted mb-6">
                Sign up to Yardura now and be the first to receive advanced wellness insights once we launch them. Get notified when AI-powered health monitoring becomes available for your dog.
              </p>
