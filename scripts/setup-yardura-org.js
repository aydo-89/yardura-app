      ...
      serviceZones: [
        {
          ...
          serviceable: true,
          zipCodes: [
            '10001', '10002', '10003', '60601', '60602', '90210',
            '55401', '55402', '55403', '55101', '55102'
          ]
        },
        {
          ...
          serviceable: true,
          zipCodes: [
            '07001', '07002', '07003', '60001', '60002',
            '55404', '55405', '55406', '55103', '55104'
          ]
        },
        {
          zoneId: 'zone-rural',
          ...
          serviceable: true,
          zipCodes: [
            '05001', '05009', '13001', '13002',
            '55407', '55408', '55105', '55106'
          ]
        }
      ],
      basePricing: {
        ...
        yardSizeMultipliers: [
          { size: 'small', multiplier: 1, description: 'Townhouse or small lot' },
          { size: 'medium', multiplier: 1.2, description: 'Standard residential lot' },
          { size: 'large', multiplier: 1.4, description: 'Large residential lot' },
          { size: 'xlarge', multiplier: 1.6, description: 'Estate or very large lot' }
        ]
      },
      settings: {
