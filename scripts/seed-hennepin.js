...
/**
 * Comprehensive Hennepin County Seeding Script
 * 
 * Seeds database with full Hennepin County coverage and extensive test data:
 * - All Hennepin County service tiles
 * - Multiple scoopers with various availability windows
 * - Multiple visits per scooper per day to test route optimization
 * - Recurring job schedules to verify recurrence logic
 * - Past and future visits for testing
 */
...
const TEST_CUSTOMERS = [
  // High-frequency customers (DAILY) - 5 customers
  ...
  // Twice-weekly customers - 10 customers
  ...
  // Bi-weekly customers - 10 customers
  ...Array.from({ length: 10 }, (_, i) => ({
