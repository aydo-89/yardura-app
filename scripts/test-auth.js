...
async function testAuth() {
  try {
    ...
    const isValid = await bcrypt.compare(testPassword, credentialsAccount.access_token);
    ...
    if (isValid) {
      ...
      console.log('Hash starts with:', credentialsAccount.access_token.substring(0, 10) + '...');
    }
