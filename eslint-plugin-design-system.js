  ...
  rules: {
    'no-adhoc-colors': {
      meta: {
        ...
        messages: {
          noAdhocColor:
            'Use design token classes instead of ad-hoc color "{{ color }}". Use {{ suggestion }} instead.',
            ...
            if (node.name.name === 'className' || node.name.name === 'class') {
              ...
              if (value && value.type === 'Literal' && typeof value.value === 'string') {
                ...
                for (const className of classes) {
                  ...
                  if (
                    !allowedColors.includes(className) &&
                    ...
                    if (
                      ...
                      if (className.includes('red-')) suggestion = 'text-red-600 for errors';
                        ...
                        suggestion = 'text-blue-600 or bg-blue-50';
                      else if (className.includes('green-'))
                        suggestion = 'text-green-600 or bg-green-50';
                      else if (
                        className.includes('gray-') ||
                        className.includes('slate-') ||
                        className.includes('zinc-')
